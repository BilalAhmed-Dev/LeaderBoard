...
const items = [
  { name: "loginform", icon: "k-i-login", selected: true, route: "/" },
  { name: "dashboard", icon: "k-i-graph", route: "/dashboard" },
  { name: "PrizePoolTable", icon: "k-i-currency", route: "/PrizePoolTable" },
];
